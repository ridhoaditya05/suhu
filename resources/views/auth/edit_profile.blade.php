    ...
    @if(auth()->check() && auth()->user()->role === 'admin')
        ...
        <div id="collapseInputData" class="collapse" aria-labelledby="headingInputData">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="Reschedule">Reschedule</a>
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Edit Profile</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="container">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ Storage::url($user->profile_images) }}" alt="Profile Image" class="img-profile rounded-circle" style="width: 130px; height: 130px;">
                                        @endif
                                    </div>
