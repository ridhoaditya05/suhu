        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">{{ isset($customize)? 'Edit Jadwal': 'Tambah Jadwal' }}</h1>
                    <ol class="breadcrumb -sm-left">
                        <li class="breadcrumb-item"><a href="{{ asset('dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ asset('Customize') }}">Customize</a></li>
                        <li class="breadcrumb-item active">{{ isset($customize)? 'Edit Jadwal': 'Tambah Jadwal' }}</li>
                    </ol>
                    <hr>
                        <div class="col-xl-12 col-lg-6">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">{{ isset($customize)? 'Edit Jadwal': 'Tambah Jadwal' }}</h6>   
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                <form action="{{ isset($customize) ? route('auth.tambah_customize.update', $customize->id) : route('auth.tambah_customize.simpan') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                    <label for="week">Week:</label>
                                    <input type="number" name="week" class="form-control" value="{{ old('week', $customize->week ?? '') }}">
                                    @error('week')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="materi" class="form-control" value="{{ old('materi', $customize->materi ?? '') }}">
                                    @error('materi')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                    ...
                                    <input type="text" class="form-control" id="instansi" name="instansi" value="{{ old('instansi', isset($customize) ? $customize->instansi : '') }}">
                                    @error('instansi')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="pax" name="pax" value="{{ old('pax', isset($customize) ? $customize->pax : '') }}">
                                    @error('pax')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tanggal" name="tanggal">
                                        ...
                                        @foreach($tanggal as $t)
                                            <option value="{{ $t->date }}" {{ (old('tanggal', $customize->tanggal ?? '') == $t->date) ? 'selected' : '' }}>
                                                {{ $t->date }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="durasi" name="durasi" step="0.5" value="{{ old('durasi', isset($customize) ? $customize->durasi : '') }}">
                                    @error('durasi')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="instruktur" name="instruktur">
                                        ...
                                        @foreach($instrukturs as $instruktur)
                                            <option value="{{ $instruktur->name }}" {{ (old('instruktur', $customize->instruktur ?? '') == $instruktur->name) ? 'selected' : '' }}>
                                                {{ $instruktur->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cc" name="cc" value="{{ old('cc', isset($customize) ? $customize->cc : '') }}">
                                    @error('cc')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="venue" name="venue" value="{{ old('venue', isset($customize) ? $customize->venue : '') }}">
                                    @error('venue')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="hotel_peserta" name="hotel_peserta" value="{{ old('hotel_peserta', isset($customize) ? $customize->hotel_peserta : '') }}">
                                    @error('hotel_peserta')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nilai_invoice" name="nilai_invoice" step="0.01" value="{{ old('nilai_invoice', isset($customize) ? $customize->nilai_invoice : '') }}">
                                    @error('nilai_invoice')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pic_peserta" name="pic_peserta" value="{{ old('pic_peserta', isset($customize) ? $customize->pic_peserta : '') }}">
                                    @error('pic_peserta')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="note" name="note" rows="3">{{ old('note', isset($customize) ? $customize->note : '') }}</textarea>
                                    @error('note')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="modul" name="modul">
                                        ...
                                        @foreach ($moduls as $modul)
                                            <option value="{{ $modul->nama_modul }}" {{ (old('modul', $customize->modul ?? '') == $modul->nama_modul) ? 'selected' : '' }}>
                                                {{ $modul->nama_modul }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="sertifikat" id="id_sertifikat" class="form-control">
                                        ...
                                        @foreach ($sertifikats as $sertifikat)
                                            <option value="{{ $sertifikat->nama_sertifikat }}" {{ (old('sertifikat', $customize->sertifikat ?? '') == $sertifikat->nama_sertifikat) ? 'selected' : '' }}>
                                ...
                                <select class="form-control" id="souvenir" name="souvenir">
                                    ...
                                    @foreach($souvenir as $s)
                                        <option value="{{ $s->name }}" {{ (old('souvenir', $customize->souvenir ?? '') == $s->name) ? 'selected' : '' }}>
                                            {{ $s->name }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @enderror
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary">{{ isset($customize)? 'Update': 'Simpan' }}</button>
                                     </div>    
                                </form>
