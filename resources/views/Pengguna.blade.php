...
<div class="card-body">
    <div class="table-responsive">
        <table class="table table-bordered m-0 font-family Jakarta Sans text-primary">
            <thead class="font-weight-bold text-secondary">
                <tr data-group="User" class="bg-primary text-white font-weight-bold">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <img src="{{ Storage::url($user->profile_images) }}" alt="Profile Image" class="img-profile rounded-circle" style="width: 40px; height: 40px;">
                    </td>
                    <td>{{ $user->name }}</td>
                    <td>{{ $user->email }}</td>
                    <td>{{ $user->role }}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body d-flex">
                    <div class="mr-3">
                    <img src="{{ Storage::url($user->profile_images) }}" alt="Profile Image" class="img-profile rounded-circle" style="width: 100px; height: 100px;">
                    </div>
