        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Fix Runing</h1>
                    <ol class="breadcrumb -sm-left">
                        <li class="breadcrumb-item"><a href="dashboard">Home</a></li>
                        <li class="breadcrumb-item active">Fix Runing</li>
                    </ol>
                    <hr></div>
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Fix Runing</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    ...
                                    <table id="myTable" class="table table-bordered m-0 font-family Jakarta Sans text-primary">
                                        ...
                                        <tr>
                                                 <!-- Kelas FixRuning -->
                                            <tr data-group="Kelas FixRuning" class="bg-primary text-white font-weight-bold">
                                                <td colspan="18">Kelas FixRuning</td>
                                            </tr>
                                            <th>No</th>
                                            <th>Week</th>
                                            <th>Materi</th>
                                            ...
                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                            <th>
                                                <a href="{{ route('fixruning.index') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <th>{{ $fixruning->modul }}</th>
                                            <th>{{ $fixruning->sertifikat}}</th>
                                            <th>{{ $fixruning->souvenir }}</th>
                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                            <td>
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('fixruning.edit', $fixruning->id) }}" class="btn btn-warning mr-2">Edit</a>
                                                <form action="{{ route('fixruning.hapus', $fixruning->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
