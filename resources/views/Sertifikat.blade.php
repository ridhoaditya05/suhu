        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Sertifikat</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">
                                        <i class="m-0 font-weight-bold text-primary fas fa-folder-open"></i> Sertifikat
                                    </h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                        ...
                                        <table id="myTable" class="table table-bordered m-0 font-family Jakarta Sans text-primary">
                                            <thead class="font-weight-bold text-secondary">
                                                ...
                                                <div class="d-flex justify-content-end">
                                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                                                <a href="{{ route('tambah.sertifikat.index') }}" class="btn btn-primary">
                                                                 Tambah Sertifikat
                                                                </a>
                                                            </div>
                                                            @endif            
                                                    <br>
                                                    <tr data-group="Sertifikat" class="bg-primary text-white font-weight-bold">
                                                        <td colspan="18">Sertifikat</td>
                                                    </tr>
                                                    <th>No</th>
                                            ...
                                            <tbody>
                                                @foreach ($sertifikats as $sertifikat)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                                                <a href="{{ asset('storage/' . $sertifikat->file) }}" target="_blank" class="btn btn-yellow">Buka File</a>
                                                            @endif
                                                            @if(auth()->check() && auth()->user()->role === 'user')
                                                                <a href="{{ asset('storage/' . $sertifikat->file) }}" download class="btn btn-success"><i class="fas fa-download"></i> Unduh</a>
                                                            @endif
                                                        </td>
                                                        @if(auth()->check() && auth()->user()->role === 'admin')
                                                        <td>
                                                            <form action="{{ route('sertifikat.delete', $sertifikat->id) }}" method="POST" class="d-flex justify-content-end">
                                                                    @csrf
                                                                    @method('DELETE')
