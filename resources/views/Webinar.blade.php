        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Webinar</h1>
                                    ...
                                    <table id="myTable" class="table table-bordered m-0 font-family Jakarta Sans text-primary">
                                        <thead class="font-weight-bold  text-secondary">            
                                            ...
                                            <tr data-group="Kelas Webinar" class="bg-primary text-white font-weight-bold">
                                                <td colspan="18">Kelas Webinar</td>
                                            </tr>
                                            <th>No</th>
                                            <th>Week</th>
                                            <th>Materi</th>
                                            ...
                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                            <th>
                                                <a href="{{ route('webinar.index') }}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $webinar->note }}</td>
                                            <th>{{ $webinar->modul }}</th>
                                            <th>{{ $webinar->sertifikat}}</th>
                                            <th>{{ $webinar->souvenir }}</th>
                                            @if(auth()->check() && auth()->user()->role === 'admin')
                                            <td>
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('webinar.edit', $webinar->id) }}" class="btn btn-warning mr-2">Edit</a>
                                                <form action="{{ route('webinar.hapus', $webinar->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
