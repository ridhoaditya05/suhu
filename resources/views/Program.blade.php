        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Program</h1>
                                    ...
                                    <table id="myTable" class="table table-bordered m-0 font-family Jakarta Sans text-primary">
                                        ...
                                        <tr>
                                            ...
                                            <tr data-group="Kelas Program" class="bg-primary text-white font-weight-bold">
                                                <td colspan="18">Kelas Program</td>
                                            </tr>
                                                <th>No</th>
                                                <th>Week</th>
                                                <th>Materi</th>
                                            ...
                                            @foreach ($kelas_program as $program)
                                                <tr>
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('jadwal.edit', $program->id) }}" class="btn btn-warning mr-2">Edit</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('auth.tambah_jadwal.hapus', $program->id ?? '') }}" method="POST" style="display:inline;">
                    @csrf
                    @method('DELETE')
